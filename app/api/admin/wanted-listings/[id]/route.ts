...
export async function PATCH(
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : 'Unable to update wanted listing.';
...
export async function DELETE(
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : 'Unable to delete wanted listing.';
    return NextResponse.json({ error: message }, { status: 400 });
  }
}
